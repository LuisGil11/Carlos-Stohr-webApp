      ...
      <Container className="d-flex justify-content-center">
        <Row className="gy-4 expo-item justify-content-between align-items-stretch">
          ...
          <Col lg={5} className="d-flex justify-content-center flex-column">
            ...
            <p className="text-apoyanos-second" style={{ textAlign: "justify" }}>
              ...
              apoyo puede realizarse en divisas a través de la plataforma Paypal
              o en Bolívares en la cuenta Bancaria de la Fundación.
            </p>
          </Col>
